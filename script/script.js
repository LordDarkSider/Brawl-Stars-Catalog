...
// Toggle button
toggle_btn = "<span class='legend-toggle' onclick='toggleFieldset(this)'>➕</span>"

function toggleFieldset(toggle) {
...
brawlers.forEach((info, b) => {
    ...
    field.classList.add("field-B" + info.get('rarity'), "collapsed");
    legend = document.createElement('legend');
    legend.innerHTML = toggle_btn+"<img class='large-icon' src='"+info.get('img')+"' alt='"+b+" icon'> " + b;
    field.appendChild(legend);
    field_content = document.createElement('div');
    field_content.className = "fieldset-content"
    field_content.id = "field-"+b;
...
themes.forEach((info, t) => {
    ...
    legend = document.createElement('legend');
    legend.innerHTML = toggle_btn+"<img class='large-icon' src='"+info.get('icon')+"' alt='"+t+" icon'> " + t;
    field.appendChild(legend);
    field_content = document.createElement('div');
    field_content.className = "fieldset-content"
    field_content.id = "field-"+t;
    field.appendChild(field_content);
...
rarities.forEach((info, r) => {
    ...
    legend = document.createElement('legend');
    legend.innerHTML = toggle_btn+"<img class='large-icon' src='"+info.get('icon')+"' alt='"+r+" icon'> " + r;
    field.appendChild(legend);
    field_content = document.createElement('div');
    field_content.className = "fieldset-content"
    field_content.id = "field-"+r;
    field.appendChild(field_content);
